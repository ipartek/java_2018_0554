...
public class App {
	...
	static final String FILE_PERSONAS = "C:\\Users\\Andoni\\Documents\\JavaKarraspio\\java_2018_0554\\migracion\\src\\main\\resources\\personas.txt";
	...
	public static void main(String[] args) throws SQLException {
		...
		try (Connection conn = ConnectionManager.getConnection()) {
			...
			try (BufferedReader br = new BufferedReader(new FileReader(new File(FILE_PERSONAS)))) {
				...
				/*
				 * if ( true) { throw new Exception("lanzamo adrede para que no comite"); }
				 */
