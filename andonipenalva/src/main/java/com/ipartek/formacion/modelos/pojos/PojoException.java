...
public class PojoException extends RuntimeException {
	...
	public static final String EXCEPTION_NOMBRE_VACIO = "No se admiten emails vacíos";
	public static final String EXCEPTION_NOMBRE_NO_VALIDO = "El formato del email no es correcto";
