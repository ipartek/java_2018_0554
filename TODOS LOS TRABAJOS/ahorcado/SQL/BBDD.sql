CREATE DATABASE  IF NOT EXISTS `adivina` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
USE `adivina`;
-- MySQL dump 10.13  Distrib 5.7.12, for Win32 (AMD64)
--
-- Host: 127.0.0.1    Database: adivina
-- ------------------------------------------------------
...
INSERT INTO `palabra` VALUES (1,'p','o');
/*!40000 ALTER TABLE `palabra` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping routines for database 'adivina'
--
...
-- Dump completed on 2019-01-23  0:40:53
