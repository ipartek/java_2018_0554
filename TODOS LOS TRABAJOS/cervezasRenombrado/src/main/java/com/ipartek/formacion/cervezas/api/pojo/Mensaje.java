...
public class Mensaje {
	...
	public void addViolations(Set<ConstraintViolation<Tipo>> violations) {
		
		if ( violations != null ) {
			this.errores = new ArrayList<ErrorMensaje>();			
			for( ConstraintViolation<Tipo> v : violations ) {			
	...
	public void addViolationsC(Set<ConstraintViolation<Cerveza>> violations) {
		
		if ( violations != null ) {
			this.errores = new ArrayList<ErrorMensaje>();			
			for( ConstraintViolation<Cerveza> v : violations ) {			
				ErrorMensaje errorMensaje = new ErrorMensaje( v.getPropertyPath().toString() , v.getMessage() );
				this.errores.add(errorMensaje);				
			}				
		}		
...
public void addViolationsCr(Set<ConstraintViolation<Compra>> violations) {
		
		if ( violations != null ) {
			this.errores = new ArrayList<ErrorMensaje>();			
			for( ConstraintViolation<Compra> v : violations ) {			
				ErrorMensaje errorMensaje = new ErrorMensaje( v.getPropertyPath().toString() , v.getMessage() );
				this.errores.add(errorMensaje);				
			}				
		}		
	...
	public void addViolationsRol(Set<ConstraintViolation<Tipo>> violations) {
