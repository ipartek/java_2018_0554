...
public class ClienteDAO  {
	...
	private static final String SQL_GET_CLIENTE_BY_ID = "SELECT cl.id , cl.nombre   FROM cervezas.compra as c, cervezas.cliente as cl WHERE c.id_cliente= cl.id and c.id=?;";
