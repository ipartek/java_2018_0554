...
public class AnimalDaoImpl implements AnimalDao{
	...
	private static final String SQL_GET_BY_ID="SELECT a.id AS 'id_animal',	a.nombre AS 'Nombre_Especie',a.peso,a.precio,d.id AS 'id_dieta', d.nombre, t.id AS 'id_tipo',t.nombre AS 'tipo_alimentacion'"
			+ "FROM animal AS a INNER JOIN tipo_animal AS t ON a.id_tipo_animal = t.id INNER JOIN dieta AS d ON a.id_dieta = d.id WHERE a.id=?;";
