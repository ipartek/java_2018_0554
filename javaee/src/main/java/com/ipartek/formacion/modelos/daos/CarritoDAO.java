...
public class CarritoDAO {
	...
	public ArrayList<Carrito> getAll() {
		...
		String sql = "SELECT c.id,perro,cantidad,raza,precio,imagen  FROM carrito_perros_borja AS c JOIN perros_borja AS p ON c.perro = p.id  ORDER BY id LIMIT 500";
	 ...
	 * @return devuelve true si se ha realizado la actualizacion de la cantidad o la
	 *         insercion de un elemento al carro devuelve false si no se ha
	 *         realizado ninguna accion
