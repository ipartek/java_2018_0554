...
<nav class="navbar navbar-expand-md navbar-dark bg-dark mb-4">
		...
		<div class="collapse navbar-collapse" id="navbarCollapse">
			<ul class="navbar-nav mr-auto">
				<li class="nav-item active"><a class="nav-link" href="#">Saludar Post<span class="sr-only">(current)</span>
				</a></li>
				<li class="nav-item active"><a class="nav-link" href="#">Saludar Get<span class="sr-only">(current)</span>
				</a></li>
