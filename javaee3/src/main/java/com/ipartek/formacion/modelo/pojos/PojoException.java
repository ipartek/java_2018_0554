...
public class PojoException extends RuntimeException {
	...
	public static final String EXCEPTION_EMAIL_VACIO = "No se admiten emails vacios";
	public static final String EXCEPTION_EMAIL_NO_VALIDO = "El formato del email no es correcto";
	public static final String EXCEPTION_PASSWORD_VACIO = "No se admiten contraseñas vacias";
