...
public class VideoDAO {
	...
	private static final String SQL_GETBYID = "SELECT v.id AS 'id_video', u.id AS 'id_usuario', email, password, nombre, codigo FROM javaee.video AS v, javaee.usuario AS u WHERE v.id_usuario = u.id AND v.id = ?;";
	private static final String SQL_GETALL = "SELECT v.id AS 'id_video', u.id AS 'id_usuario', email, password, nombre, codigo FROM javaee.video AS v, javaee.usuario AS u WHERE v.id_usuario = u.id ORDER BY v.id DESC LIMIT 1000;";
