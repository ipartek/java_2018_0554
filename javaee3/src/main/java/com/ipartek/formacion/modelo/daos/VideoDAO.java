...
public class VideoDAO {
	...
	private static final String SQL_GETBYID = "SELECT v.id as 'id_video', u.id as 'id_usuario', nombre, codigo, email, `password` FROM video as v, usuario as u WHERE v.id_usuario = u.id AND v.id = ? ORDER BY v.id DESC LIMIT 5;";
