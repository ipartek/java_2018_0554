...
<body class="text-center">
	...
	<form novalidate action="login" method="post" class="form-signin">
		...
		<label for="email" class="sr-only">Correo Electronico:</label> <input
			...
			value="auraga@ipartek.com" placeholder="Inserta tu email" required
			autofocus> <label for="pass" class="sr-only">Contraseña</label>
		<input type="password" name="pass" class="form-control"
			value="12345678" placeholder="minimo 6 caracteres" required>
		...
		<label for="idioma">Selecciona un Idioma</label> <select name="idioma"
