  ...
  <body class="text-center"> 	
    ...
    <form novalidate action="login" method="post" class="form-signin">    
     ...
     <c:if test="${not empty mensaje}">	  
      ...
      <input type="email" name="email" class="form-control" value="oscar@ipartek.com" placeholder="tu@email.com" required autofocus>
      
      <label for="pass" class="sr-only">Contraseña</label>
      <input type="password" name="pass" class="form-control" value="1234567" placeholder="minimo 6 caracteres" required>
