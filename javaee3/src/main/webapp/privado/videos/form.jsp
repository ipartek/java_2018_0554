...
<%@ include file="../../includes/mensajes.jsp"  %>
	...
	<div class="row">
		...
		<div class="col-6 pt-4">
			<iframe width="450" height="200" src="https://www.youtube.com/embed/${video.codigo}" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
		</div>			
