    ...
    <main role="main" class="container">
		...
		<form action="privado/videos" method="post">
			...
			<div class="form-group">
			    ...
			    <input type="text" name="nombre" value="${video.nombre}" class="form-control" placeholder="nuevo nombre del vídeo">			    
			</div>
			
			<div class="form-group">
			    <label for="codigo">Código</label>
			    <input type="text" name="codigo" value="${video.codigo}" class="form-control" placeholder="minimo 5 maximo 50 caracteres">			    
			</div>
