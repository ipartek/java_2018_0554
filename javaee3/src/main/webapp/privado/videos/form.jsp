		...
		<form action="privado/videos" method="post">
			...
			<div class="form-group">
				<label for="nombre">Nombre</label> <input type="text" name="nombre"
					value="${video.nombre}" class="form-control"
					placeholder="minimo 5 letras" minlength="5" maxlength="150">
				<small id="nombre" class="form-text text-muted">minimo 5
					letras, maximo 150</small>
			</div>

			<div class="form-group">
				<label for="codigo">Código</label> <input type="text" name="codigo"
					value="${video.codigo}" class="form-control"
					placeholder="11 caracteres"> <small id="codigo"
					class="form-text text-muted">11 caracteres</small>
			</div>


			<!-- <div class="form-group">
				<label for="id_usuario">Selecciona Usuario</label> <select
					name="id_usuario">
			...
			<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog"
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						...
						<div class="modal-body">¿ Estas serguro que deseas eliminar
							el registro ?</div>
